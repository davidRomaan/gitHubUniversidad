...
import co.edu.eam.disenosoft.universidad.contrloadores.ControladorVentanaVerCalificaciones;
...
public class VentanaVerCalificaciones extends javax.swing.JInternalFrame {
	...
	private void listarCombo(Asignatura a) {
		try {
			List<Curso> lista = controlador.cursosAsig(a);
	...
	private void nombreDeCampos(List<Nota> notas) {
	...
	private void listarTabla(Curso c) {
		try {
			...
			for (Estudiante lista : estudiantes) {
				...
				double def = controlador.calificacionEstudiante(notas);
