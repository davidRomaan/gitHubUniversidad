...
import co.edu.eam.disenosoft.universidad.contrloadores.ControladorVentanaVerEstudiante;
...
public class DialogoVerEstudiante extends javax.swing.JDialog {
	...
	private ControladorVentanaVerEstudiante controlador;
    ...
    public DialogoVerEstudiante(Estudiante e) {
    	...
    	controlador = new ControladorVentanaVerEstudiante();
        initComponents();
        est = e;
        try {
			llenarTablaNotaDialogo(est);
		} catch (Exception e1) {
     		e1.printStackTrace();
		}
        creditos();
    ...
    public void creditos(){
    	...
    	try {
		int	creditos = controlador.crditosEstudiante(est);
    	...
    	/**
    	 * llena la tabla con la evaluacion de un estudiante
    	 * @param e el estudiante
    	 * @throws Exception en caso de que haya una excepcion de negocio
    	 */
    	public void llenarTablaNotaDialogo(Estudiante e) throws Exception {
    		DefaultTableModel dtm = (DefaultTableModel) tablaNotas.getModel();
    		dtm.setRowCount(0);

    		java.util.List<Nota> lista = controlador.listarTablaEstudiante(e);
    		for (Nota nota : lista) {
    			dtm.addRow(new Object[] { nota.getEvaluacion().getNombre(),nota.getValor() ,nota.getEvaluacion().getPorcentaje() });
			}
