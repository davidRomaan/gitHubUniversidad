...
@NamedQueries({
	...
	@NamedQuery(name = Profesion.LISTAR_PROFESIONES, query = "SELECT pro FROM Profesion pro ORDER BY pro.nombre ASC")
})
@Entity
@Table(name="tb_profesion")

/**
 * consulta que trae todas las profesiones
 * @author david
 */
public class Profesion implements Serializable{
	
	public static final String LISTAR_PROFESIONES = "listarProfesiones";
